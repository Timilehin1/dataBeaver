...
WebUI.setText(findTestObject('Form_OR/Form Object Repo/input_Form Name_name'), 'Automating form creation')
...
WebUI.verifyElementPresent(findTestObject('Form_OR/Form Object Repo/div_Form Successfully Created'), 0)
